...
static const char *fonts[]          = { "DepartureMono Nerd Font:size=12:style=Bold", "monospace:size=12" };
static const char dmenufont[]       = "DepartureMono Nerd Font:size=12:style=Bold";
